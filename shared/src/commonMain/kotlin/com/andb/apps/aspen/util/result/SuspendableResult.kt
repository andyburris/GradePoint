package com.andb.apps.aspen.util.result
...
suspend fun <V : Any?> SuspendableResult<V, *>.onSuccess(f: suspend (V) -> Unit): SuspendableResult<V, *> {
    fold(f, {})
    return this
}

suspend fun <E : Exception> SuspendableResult<*, E>.onFailure(f: suspend (E) -> Unit): SuspendableResult<*, E> {
    fold({}, f)
    return this
}
